...
from .gradient_descent_base import LinfBaseGradientDescent, LinfBaseGradientDescentMCSampling
...
class LinfProjectedGradientDescentAttackMCSampling(LinfBaseGradientDescentMCSampling):
    """Linf Projected Gradient Descent
